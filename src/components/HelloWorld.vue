<template>
  <div id="slider">
    <div class="window" @mouseover="stop" @mouseleave="play">
      ...
      <ul class="dots">
        <li v-for="(item, i) in sliders.length" :key="i"></li>
      </ul>
      <ul class="direction">
        <li class="left" @click="move(600, 1, 30)">
        ...
        <li class="right" @click="move(600, -1, 30)">
...
export default {
  ...
  methods:{
    ...
    move(offset, direction, speed) {
      ...
      this.currentIndex += -((offset * direction) / 600)
      this.currentIndex > 5 ? this.currentIndex = 1 : ''
      this.currentIndex < 1 ? this.currentIndex = 5 : ''                   
    ...
    jump(index) {
      ...
      this.speed = Math.abs(index - this.currentIndex) === 0 ? this.speed : Math.abs(index - this.currentIndex) * 30
      this.move(offset, direction, this.speed)
    },
    play() {
      if (this.clock) {
